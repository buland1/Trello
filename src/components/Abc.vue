            ...
            <v-card class="mx-auto" max-width="auto" max-height="auto">
              <v-card-text>
                ...
                >
                  ...
                  <!-- <v-card class="blue white--text"> <span class="text-sm-left pa-2 mb-2">  {{value.issueCase}} </span> -->
                  <v-card class="text-sm-left pl-1"> {{value.issueCase}} 
                  <div style="float:right;">
                  <v-menu bottom left class="text-lg-right" >
            <template  v-slot:activator="{ on, attrs }">
              <v-btn dark icon v-bind="attrs" v-on="on" color="white">
...
export default {
  ...
  methods: {
    save() {
      ...
      //get = local storage bata data line

      if (fetchIssuesList === null) {
        //stringify object and store
        // set= local storage ma save garxa
